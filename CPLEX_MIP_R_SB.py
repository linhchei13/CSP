...
def solve_bin_packing_with_rotation(W, H, rectangles, lower_bound, upper_bound, time_limit=1800):
    """
    ...
    # Single instance mode
        ...
        try:
            ...
            for i in range(2, 2 + n_items):
                ...
                w, h, d = int(line[0]), int(line[1]), int(line[2])
                for _ in range(d):
            ...
            # Solve with MIP
            solution = solve_bin_packing_with_rotation(W, H, rectangles, lower_bound, upper_bound, time_limit=1800)
